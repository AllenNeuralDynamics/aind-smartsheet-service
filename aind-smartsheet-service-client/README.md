...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**get_exaspim_info**](docs/DefaultApi.md#get_exaspim_info) | **GET** /get_exaspim_info | Get Exaspim Info
...
## Documentation For Models
 ...
 - [ExaSPIMInfo](docs/ExaSPIMInfo.md)
 - [FundingModel](docs/FundingModel.md)
 - [HTTPValidationError](docs/HTTPValidationError.md)
 - [HealthCheck](docs/HealthCheck.md)
 - [ImagingQueue](docs/ImagingQueue.md)
 - [MouseTracker](docs/MouseTracker.md)
 - [PerfusionsModel](docs/PerfusionsModel.md)
 - [ProtocolsModel](docs/ProtocolsModel.md)
 - [QcSheet](docs/QcSheet.md)
 - [SampleTracking](docs/SampleTracking.md)
