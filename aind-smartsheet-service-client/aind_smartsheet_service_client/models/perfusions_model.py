...
class PerfusionsModel(BaseModel):
    ...
    """ # noqa: E501
    subject_id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, alias="subject id")
    ...
    animal_weight_prior__g: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, alias="animal weight prior (g)")
    output_specimen_id_s: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, alias="Output specimen id(s)")
    ...
    def subject_id_validate_regular_expression(cls, value):
    ...
    @field_validator('animal_weight_prior__g')
    def animal_weight_prior__g_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('output_specimen_id_s')
    def output_specimen_id_s_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
